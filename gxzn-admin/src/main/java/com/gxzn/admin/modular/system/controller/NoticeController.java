...
import com.gxzn.admin.core.common.constant.dictmap.NoticeMap;
...
import com.gxzn.admin.modular.system.service.NoticeService;
import com.gxzn.admin.modular.system.wrapper.NoticeWrapper;
...
public class NoticeController extends BaseController {
    ...
    public Object delete(@RequestParam Long noticeId) {
        ...
        //缓存通知名称
        LogObjectHolder.me().set(ConstantFactory.me().getNoticeTitle(Convert.toStr(noticeId)));
