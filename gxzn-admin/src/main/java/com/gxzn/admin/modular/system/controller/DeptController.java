...
import com.gxzn.admin.core.common.constant.dictmap.DeptDict;
...
import com.gxzn.admin.modular.system.model.DeptDto;
import com.gxzn.admin.modular.system.service.DeptService;
import com.gxzn.admin.modular.system.wrapper.DeptTreeWrapper;
import com.gxzn.admin.modular.system.wrapper.DeptWrapper;
...
public class DeptController extends BaseController {
    ...
    @ResponseBody
    public List<ZTreeNode> tree(@RequestParam(value = "deptId", required = false) Long deptId) {
        List<ZTreeNode> tree = this.deptService.tree();
        if (deptId != null) {
            tree.removeIf(ztreeNode -> ztreeNode.getId() == deptId || ztreeNode.getPId() == deptId);
        }
    ...
    public Object detail(@PathVariable("deptId") Long deptId) {
        ...
        deptDto.setPName(ConstantFactory.me().getDeptName(Convert.toStr(deptDto.getPid())));
        return deptDto;
    }
